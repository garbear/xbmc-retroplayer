...
bool CGameSettings::OnSettingChanging(const CSetting *setting)
{
  if (setting == NULL)
    return false;
...
bool CGameSettings::OnSettingUpdate(CSetting* &setting, const char *oldSettingId, const TiXmlNode *oldSettingNode)
{
  if (setting == NULL)
    return false;
...
void CGameSettings::OnSettingPropertyChanged(const CSetting *setting, const char *propertyName)
{
  if (setting == NULL)
    return;
}
