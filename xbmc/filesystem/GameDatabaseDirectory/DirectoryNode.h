...
namespace XFILE
{
  namespace GAMEDATABASEDIRECTORY
  {
    ...
    typedef enum _NODE_TYPE
    {
      ...
      NODE_TYPE_PUBLISHER,
      //NODE_TYPE_DEVELOPER, // Copy from NODE_TYPE_YEAR
      NODE_TYPE_YEAR,
      //NODE_TYPE_RATING, // Copy from NODE_TYPE_YEAR
      //NODE_TYPE_MOST_PLAYED, // Need nav() functions in CGameDatabase
      //NODE_TYPE_RECENTLY_PLAYED,
      //NODE_TYPE_RECENTLY_ADDED,
    } NODE_TYPE;
