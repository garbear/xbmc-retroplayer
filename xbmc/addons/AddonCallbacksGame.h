...
public:
  ...
  static bool EnvironmentGetSystemDirectory(void* addonData, char *buffer, size_t buffer_size);
  ...
  static bool EnvironmentGetLibretroPath(void* addonData, char *buffer, size_t buffer_size);
  static bool EnvironmentGetContentDirectory(void* addonData, char *buffer, size_t buffer_size);
  static bool EnvironmentGetSaveDirectory(void* addonData, char *buffer, size_t buffer_size);
