...
namespace GAME
{
  ...
  public:
    ...
    virtual bool Supports(EDEINTERLACEMODE mode) override { return m_renderManager.Supports(mode); }
    virtual bool Supports(EINTERLACEMETHOD method) override { return m_renderManager.Supports(method); }
