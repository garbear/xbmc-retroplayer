...
enum CONTEXT_BUTTON { CONTEXT_BUTTON_CANCELLED = 0,
                      ...
                      CONTEXT_BUTTON_ADDON1,
                      CONTEXT_BUTTON_ADDON2,
                      CONTEXT_BUTTON_ADDON3,
                      CONTEXT_BUTTON_ADDON4,
                      CONTEXT_BUTTON_ADDON5,
                      CONTEXT_BUTTON_ADDON6,
                      CONTEXT_BUTTON_ADDON7,
                      CONTEXT_BUTTON_ADDON8,
                      CONTEXT_BUTTON_ADDON9,
